...
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:flutter_tts/flutter_tts.dart';   // 👈 Added
...
class _RegisteredFacesScreenState extends State<RegisteredFacesScreen> {
  ...
  Future<void> _speakIntro() async {
    await flutterTts.speak("You are in registered faces screen");
  }
  // ------------------------------------------------------
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Colors.deepPurple.withAlpha(400), const Color(0xFFFFFFFF)],
        ),
      ),
      child: Scaffold(
        backgroundColor: Colors.transparent,
  ...
  @override
  void dispose() {
    flutterTts.stop();   // 👈 important cleanup
    dbHelper.close();
    super.dispose();
  }
}
